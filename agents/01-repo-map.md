...
- `crates/oac/src/verification.rs`: shared proof/invariant verification orchestration, common reachability/recursion checks, and per-obligation QBE/SMT batch runner.
